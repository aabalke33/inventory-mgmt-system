...
/**
 * This class provides control over the Product Modify Page GUI
 * @author Aaron Balke
 */
public class ProductModController implements Initializable {
    ...
    /**
     * This variable defines the selected product
     */
    ...
    /**
     * This method initializes the Product Modify GUI
     * @param url
    ...
    /**
     * This method sets the modified information to update the product info
    ...
    public void saveOnAction(ActionEvent actionEvent) {
        try {
            ...
            // REVISION FOR ATTEMPT 2 productId should not be a new ID everytime for modification
            // It should be the same productId as the original product selectProduct.getId() vs getId()
            ...
            // REVISION FOR ATTEMPT 2 The original data for the product can be deleted since it will be
            // replaced by the updated data
    ...
    /**
     * This method updates the available parts table for the GUI
     */
    public void updatePartTable() {
        availableParts.setItems(Inventory.getAllParts());
    }
    /**
     * This method updates the associated parts table for the GUI
     */
